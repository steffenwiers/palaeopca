...
# PPCA
import ppca
from ppca.P1Gui.P1DataWindow import P1DataWindow
from ppca.P1Backend.P1DataObject import P1DataObject

def _icon(name, style = ""):
    icon = ppca.P1Utils.P1PixmapCache.getIcon(name, style)
    return icon
...
class P1MainWindow(QMainWindow):
    def __init__(self, parent = None):
        ...
        self.setWindowTitle("PPCA {0}".format(ppca.__version__))
    ...
    def on_settings_triggered(self):
        from ppca.P1Gui.P1SettingsDialog import P1SettingsDialog
    ...
    def on_import_triggered(self):
        from ppca.P1Gui.P1ImportDialog import P1ImportDialog
