...
from ppca.P1Gui.P1ResultsModel import P1ResultsModel
...
class P1PCAWindow(QWidget):
    ...
    def __setupMenu(self):
        ...
        self.__action_export_data.setIcon(ppca.P1Utils.P1PixmapCache.getIcon("file-export", "solid"))
        ...
        self.__action_export_sequence.setIcon(ppca.P1Utils.P1PixmapCache.getIcon("chart-bar", "solid"))
    ...
    def __export_sequence(self):
        from ppca.P1Gui.P1ExportDialogs import P1SequenceExport

        dlg = P1SequenceExport(self)
        dlg.setWindowIcon(ppca.P1Utils.P1PixmapCache.getIcon("chart-bar", "solid"))
